...
#     print(f"=> Git SHA {train_run_id}")
    ...
    #     initial_lr=1e-3,
    #     milestones="2, 5, 15, 30",
    #     gamma_lr=0.1, #lr will be reduced by 0.1 at each epoch
    #     weight_decay=1e-5,
    #     # Model architecture parameters. See model class for details.
    #     model_size="small",
    #     p_dropout_fc=0.5,
    ...
    #         **base_hparams,
    #         "initial_lr": 1e-1,
    #         "milestones": "5, 15, 30", # means lr will be reduced at 5th,15th and 30th epoch
    #     },
    #     {
    #         **base_hparams,
    #         "initial_lr": 1e-2,
    ...
    #     {
    #         **base_hparams,
    #         "weight_decay": 1e-3, #controls regularization
    #     },
    # ]
